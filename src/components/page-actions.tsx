...
export function ViewOptionsPopover({
  ...
  // Using a fallback for translations if fumadocs i18n hook is not directly exposed this way
  // Actually, we can just hardcode english for now, or just provide simple strings.
